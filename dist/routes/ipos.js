...
ipos.get('/api/recentipos', /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var params, response, fileContent, result;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          fileContent = response.Body.toString('utf-8');
          _context.next = 7;
          return (0, _csvtojson["default"])(fileContent);
        case 7:
...
ipos.get('/api/thisweekipos', /*#__PURE__*/function () {
...
ipos.get('/api/iposcreeners', /*#__PURE__*/function () {
